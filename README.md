...
*   **`project8-cv.ipynb`**: This is the core notebook.
    ...
    *   Load (as a dataset) all the masks located in the folder named "Masks" (generated by us, load both "sam_generated_masks-2.zip", "sam_generated_masks.zip", "watershed_masked.zip", "labelme_generated_masks.zip", "kmeans_multiclass_masks.zip", dino masks will be generated after running the code) or generate yours by running all other notebooks to provide a final side-by-side visual comparison of segmentation techniques.
